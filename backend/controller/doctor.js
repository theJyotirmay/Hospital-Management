...
const update_medicine = async (req, res) => {
    const { _id, medicine, about, primary_diagnosis, investigation_advice, final_diagnosis, treatment } = req.body;
    console.log(_id, medicine, about, primary_diagnosis, investigation_advice, final_diagnosis, treatment);
    try {
        if (!_id) {
            ...
            if (!appointment) {
                ...
                await appointments.findByIdAndUpdate({ _id }, { medicine, about, primary_diagnosis, investigation_advice, final_diagnosis, treatment });
